    ...
    render() {
            ...
            menu = (
                <div className='ui dropdown icon item' id='topmenudropdown'>
                  <i className='bars icon'></i>
                    <div className='menu'>
                      <div className='item'><i className='id card outline icon'></i>Profile</div>
                      <div className='item'><i className='campground icon'></i>Code camp</div>
        ...
        return (
            <div className='ui top attached menu'>
              ...
              <div className='ui item'><i className='campground icon'></i>Code camp</div>
